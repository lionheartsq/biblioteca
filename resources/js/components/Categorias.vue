                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" @click="abrirModal('categoria','crear')" class="btn btn-secondary">
                    ...
                    <div class="modal-dialog modal-primary modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" v-model="categoria" class="form-control" placeholder="Nombre de categoria">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="crearCategoria()">Guardar</button>
                                <button type="button" v-if="tipoAccion==2" class="btn btn-warning" @click="editarCategoria()">Editar</button>
                            </div>
                        </div>
                        <!-- /.modal-content -->
                    </div>
    ...
    export default {
        ...
        methods : {
            ...
            activarCategoria(id){
                ...
                swalWithBootstrapButtons.fire({
                title: 'Quiere activar esta categoria?',
                icon: 'warning',
                showCancelButton: true,
            ...
            validarCategoria(){
                ...
                if (!this.categoria) this.errorMensaje.push("El nombre de la categoria no puede estar vacio");
                ...
                case "categoria":
                {
                    switch (accion) {
                        case 'crear':{
                            this.modal=1;
                            this.categoria='';
                            this.tituloModal='Crear nueva categoria';
                            this.tipoAccion= 1;
                            break;
                        }
                        case 'actualizar':{
